 ...
 */
class OutlinePass extends _Pass_js__WEBPACK_IMPORTED_MODULE_0__.Pass {
	...
	constructor( resolution, scene, camera, selectedObjects ) {
		 ...
		 * @default (1,1,1)
		 */
		this.visibleEdgeColor = new three__WEBPACK_IMPORTED_MODULE_1__.Color( 1, 1, 1 );
		 ...
		 */
		this.hiddenEdgeColor = new three__WEBPACK_IMPORTED_MODULE_1__.Color( 0.1, 0.04, 0.02 );
		...
		this.renderTargetMaskBuffer = new three__WEBPACK_IMPORTED_MODULE_1__.WebGLRenderTarget( this.resolution.x, this.resolution.y );
		this.renderTargetMaskBuffer.texture.name = 'OutlinePass.mask';
		this.renderTargetMaskBuffer.texture.generateMipmaps = false;

		this.depthMaterial = new three__WEBPACK_IMPORTED_MODULE_1__.MeshDepthMaterial();
		this.depthMaterial.side = three__WEBPACK_IMPORTED_MODULE_1__.DoubleSide;
		this.depthMaterial.depthPacking = three__WEBPACK_IMPORTED_MODULE_1__.RGBADepthPacking;
		this.depthMaterial.blending = three__WEBPACK_IMPORTED_MODULE_1__.NoBlending;

		this.prepareMaskMaterial = this._getPrepareMaskMaterial();
		this.prepareMaskMaterial.side = three__WEBPACK_IMPORTED_MODULE_1__.DoubleSide;
		this.prepareMaskMaterial.fragmentShader = replaceDepthToViewZ( this.prepareMaskMaterial.fragmentShader, this.renderCamera );

		this.renderTargetDepthBuffer = new three__WEBPACK_IMPORTED_MODULE_1__.WebGLRenderTarget( this.resolution.x, this.resolution.y, { type: three__WEBPACK_IMPORTED_MODULE_1__.HalfFloatType } );
		this.renderTargetDepthBuffer.texture.name = 'OutlinePass.depth';
		this.renderTargetDepthBuffer.texture.generateMipmaps = false;

		this.renderTargetMaskDownSampleBuffer = new three__WEBPACK_IMPORTED_MODULE_1__.WebGLRenderTarget( resx, resy, { type: three__WEBPACK_IMPORTED_MODULE_1__.HalfFloatType } );
		this.renderTargetMaskDownSampleBuffer.texture.name = 'OutlinePass.depthDownSample';
		this.renderTargetMaskDownSampleBuffer.texture.generateMipmaps = false;

		this.renderTargetBlurBuffer1 = new three__WEBPACK_IMPORTED_MODULE_1__.WebGLRenderTarget( resx, resy, { type: three__WEBPACK_IMPORTED_MODULE_1__.HalfFloatType } );
		this.renderTargetBlurBuffer1.texture.name = 'OutlinePass.blur1';
		this.renderTargetBlurBuffer1.texture.generateMipmaps = false;
		this.renderTargetBlurBuffer2 = new three__WEBPACK_IMPORTED_MODULE_1__.WebGLRenderTarget( Math.round( resx / 2 ), Math.round( resy / 2 ), { type: three__WEBPACK_IMPORTED_MODULE_1__.HalfFloatType } );
		this.renderTargetBlurBuffer2.texture.name = 'OutlinePass.blur2';
		this.renderTargetBlurBuffer2.texture.generateMipmaps = false;

		this.edgeDetectionMaterial = this._getEdgeDetectionMaterial();
		this.renderTargetEdgeBuffer1 = new three__WEBPACK_IMPORTED_MODULE_1__.WebGLRenderTarget( resx, resy, { type: three__WEBPACK_IMPORTED_MODULE_1__.HalfFloatType } );
		this.renderTargetEdgeBuffer1.texture.name = 'OutlinePass.edge1';
		this.renderTargetEdgeBuffer1.texture.generateMipmaps = false;
		this.renderTargetEdgeBuffer2 = new three__WEBPACK_IMPORTED_MODULE_1__.WebGLRenderTarget( Math.round( resx / 2 ), Math.round( resy / 2 ), { type: three__WEBPACK_IMPORTED_MODULE_1__.HalfFloatType } );
		...
		this._fsQuad = new _Pass_js__WEBPACK_IMPORTED_MODULE_0__.FullScreenQuad( null );

		this.tempPulseColor1 = new three__WEBPACK_IMPORTED_MODULE_1__.Color();
		this.tempPulseColor2 = new three__WEBPACK_IMPORTED_MODULE_1__.Color();
		this.textureMatrix = new three__WEBPACK_IMPORTED_MODULE_1__.Matrix4();
	...
	_getPrepareMaskMaterial() {
		...
		return new three__WEBPACK_IMPORTED_MODULE_1__.ShaderMaterial( {
			...
			uniforms: {
				...
				'cameraNearFar': { value: new three__WEBPACK_IMPORTED_MODULE_1__.Vector2( 0.5, 0.5 ) },
	...
	_getEdgeDetectionMaterial() {
		...
		return new three__WEBPACK_IMPORTED_MODULE_1__.ShaderMaterial( {
			...
			uniforms: {
				...
				'visibleEdgeColor': { value: new three__WEBPACK_IMPORTED_MODULE_1__.Vector3( 1.0, 1.0, 1.0 ) },
				'hiddenEdgeColor': { value: new three__WEBPACK_IMPORTED_MODULE_1__.Vector3( 1.0, 1.0, 1.0 ) },
			},
...
OutlinePass.BlurDirectionX = new three__WEBPACK_IMPORTED_MODULE_1__.Vector2( 1.0, 0.0 );
OutlinePass.BlurDirectionY = new three__WEBPACK_IMPORTED_MODULE_1__.Vector2( 0.0, 1.0 );
